    ...
    <div className="h-110 w-65 overflow-hidden rounded-2xl bg-[#101010] group shrink-0">
      ...
      >
        <div className="flex justify-between items-center font-[Nunito] p-4">
          <span className=" text-[0.85rem] bg-black/50 pr-2 pl-1 py-1 rounded-xl flex items-center justify-center">
            ⭐️ 8.2
          </span>
          <span className="text-white text-[0.8rem] bg-red-500 px-2 py-1 rounded-xl font-bold">
            TRENDING
          </span>
        </div>
